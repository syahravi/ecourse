...
class ExamController extends Controller
{
    public function index($slug)
    {
        ...
        return view('admin.exams.index', compact('exams', 'course'));
    }
    ...
    public function store($slug, ExamRequest $request)
    {
        ...
        return redirect()->route('admin.exams.index', $slug)->with('success', 'Exam created successfully.');
    }
    ...
    public function update($slug, ExamRequest $request, Exam $exam)
    {
        ...
        return redirect(route('admin.exams.index', $course))->with('toast_success', 'exams Updated');
    }
    ...
    {
        // Ambil semua ujian yang terkait dengan kursus
        $exams = Exam::where('course_id', $course->id)->get();
    
        // Melewatkan data kursus dan ujian ke view
        return view('admin.exams.show', compact('course', 'exams'));
    }
