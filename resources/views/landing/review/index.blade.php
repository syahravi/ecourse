...
@section('content')
    ...
    <section class="py-24 bg-gray-100  lg:py-32">
        <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="max-w-2xl mx-auto text-center">
                <h2 class="text-3xl font-bold leading-tight text-black sm:text-4xl lg:text-5xl">TESTIMONI PELANGAN</h2>
                <p class="max-w-lg mx-auto mt-4 text-base leading-relaxed text-gray-600">Temukan kegembiraan sejati melalui
