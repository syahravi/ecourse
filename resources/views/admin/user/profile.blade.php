            ...
            <div class="card card-primary card-outline">
                <div class="card-body box-profile">
                    <div class="text-center">
                       <img class="profile-user-img w-full h-full img-circle object-cover border-0" src="{{ $user->avatar }}" alt="User profile picture">
                    ...
                    <ul class="list-group list-group-unbordered">
                        <li class="list-group-item">
                            ...
                            @if(filter_var($user->instagram, FILTER_VALIDATE_URL))
                            <a href="{{ $user->instagram }}" class="text-blue-500 hover:text-blue-700 transition duration-300 ease-in-out">
                                <span class="font-bold">Instagram</span> {{ $user->name }}
                            </a>
                        @else
                            <span class="text-gray-500">Instagram link is not valid</span>
                        @endif                        
                        </li>
                        <li class="list-group-item">
                            ...
                            @if (filter_var($user->github, FILTER_VALIDATE_URL))
                                <a href="{{ $user->github }}"
                                    class="text-blue-500 hover:text-blue-700 transition duration-300 ease-in-out">
                                    <span class="font-bold">GitHub</span> {{ $user->name }}
                                </a>
                            @else
