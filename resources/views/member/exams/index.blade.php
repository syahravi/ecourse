...
@section('content')
    ...
    <x-button-create title="ADD NEW SOAL" :url="route('member.exams.create', $course->slug)" />
            ...
            <tbody>
                @foreach ($exams as $exam)
                    <tr>
                        ...
                        <td>
                            <x-button-edit :url="route('member.exams.edit', [$course->slug, $exam->id])" class="sm:mr-2" />
