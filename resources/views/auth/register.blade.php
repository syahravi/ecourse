            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-0 rounded-md">
                <div class="flex flex-col items-center justify-center px-4 py-10 bg-white sm:px-6 lg:px-8 sm:py-16 lg:py-7">
                    ...
                    <div class="xl:w-full xl:max-w-md 2xl:max-w-md xl:mx-auto ">
                                ...
                                <div class="relative mt-2.5">
                                    <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                        <svg class="w-5 h-5 text-gray-400 focus-within:text-gray-600"
                                            ...
                                            stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M16 12a4 4 0 10-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                                        </svg>
                                    </div>
                        ...
                        <!-- Tambahkan bagian ini untuk menampilkan pesan verifikasi email -->
                        @if (session('status') == 'verification-link-sent')
                            <div class="text-green-500 mt-3 bg-green-100 border border-green-400 rounded-md p-3">
                                Tautan verifikasi email telah dikirim ke alamat email Anda.
                            </div>
                        @endif
                    </div>
                </div>
