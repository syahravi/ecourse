...
@section('content')
    <div class="p-4 sm:ml-64">
        <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
            <h1 class="text-2xl font-bold mb-4 text-center">Ujian untuk {{ $course->name }}</h1>
            ...
            <form id="examForm" action="{{ route('exams.submitExam', $course->slug) }}" method="POST" class="w-full">
                @csrf
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    @foreach ($exams as $soal)
    ...
    <aside id="separator-sidebar"
        ...
        <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
            <div class="md:col-span-1">
                <h1 class="text-2xl font-bold mb-4">Soal</h1>
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#submitButton').click(function() {
                $('#examForm').submit(); // Submit form ketika tombol submit ditekan
            });
        });
    </script>
@endsection
