            ...
            <tbody>
                @foreach ($videos as $i => $video)
                    <tr>
                        ...
                        <td>
                            <x-button-edit :url="route('member.video.edit', [$course->slug, $video->id])" class="sm:mr-2"/>
                            <x-button-delete :id="$video->id" :url="route('member.video.destroy', $video->id)" class="sm:mr-2" />
                        </td>
                    </tr>
                @endforeach
            </tbody>
