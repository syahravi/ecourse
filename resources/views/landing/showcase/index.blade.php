            ...
            <div class="flex flex-row overflow-x-auto md:grid md:grid-cols-3 gap-4 items-start">
                @foreach ($showcases as $showcase)
                    <div class="min-w-full bg-slate-800 rounded-lg border border-slate-600">
                        ...
                        <div class="text-center space-y-2 text-sm text-gray-300 border-t border-dashed border-slate-700">
                            <a href="{{ $showcase->link }}" class="block px-4 py-2 bg-blue-500 text-white font-semibold rounded-md hover:bg-blue-600 transition duration-300">
                                Kunjungi Showcase
                            </a>
                        </div>                        
